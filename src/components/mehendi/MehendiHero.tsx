    ...
    <section className="relative w-full min-h-[90vh] flex items-center justify-center bg-background px-6 lg:px-20 pt-32 pb-16 overflow-hidden">
      <div className="max-w-[1400px] w-full mx-auto flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8">
        ...
        >
          ...
          >
            We transform hands into canvas. Sri Sanjana specializes in hyper-realistic portraits and elaborate traditional motifs using 100% organic, hand-mixed henna for the richest bridal stain.
          </motion.p>
          <motion.div
          ...
          >
            <a href="#services" className="inline-flex items-center gap-3 bg-foreground text-background px-8 py-4 text-xs font-bold uppercase tracking-[0.2em] hover:bg-gold transition-colors duration-300">
              View Portfolios
