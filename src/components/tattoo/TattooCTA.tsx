...
export default function TattooCTA() {
  return (
    <section className="w-full py-32 bg-background flex justify-center items-center px-6">
      ...
      >
        ...
        <p className="text-foreground/70 font-sans text-sm md:text-base font-light max-w-lg mb-12 leading-relaxed">
          Book a consultation with our artists to discuss sizing, placement, and custom designs. Your body is a canvas; let us treat it with the respect it deserves.
        </p>
