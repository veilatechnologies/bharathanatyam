...
export default function TattooProcess() {
  const modes = [
    {
      num: "01",
      title: "Consultation",
      desc: "Discuss concepts, placement, and sizing. We listen closely to ensure the final piece accurately represents your vision."
    },
    {
      num: "02",
      title: "Custom Design",
      desc: "Our artists digitally draft the stencil, ensuring perfect anatomical flow and alignment before any ink touches skin."
    },
    {
      num: "03",
      title: "The Ink Session",
      desc: "Conducted in a sterile, highly professional environment prioritizing your comfort, safety, and the artwork's precision."
    },
    {
      num: "04",
      title: "Aftercare",
      desc: "We provide premium healing balms, breathable medical wraps, and strict, easy-to-follow care instructions for flawless healing."
    }
  ];
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 flex flex-col lg:flex-row gap-16 lg:gap-24">
        ...
        >
          ...
          <p className="text-background/60 font-sans text-sm leading-relaxed font-light">
            We adhere to the highest global hygiene standards. Every session uses single-use disposable needles and vegan, heavy-metal-free inks.
          </p>
        </motion.div>
