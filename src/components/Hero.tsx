    ...
    <>
      <section ref={ref} className="relative w-full h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div 
          ...
          className="relative z-10 w-full text-center px-8 mt-16"
        >
          <h1 className="text-6xl md:text-8xl lg:text-[130px] font-serif text-white tracking-[0.1em] font-bold drop-shadow-2xl uppercase">
            Sri Sanjana
          </h1>
        </motion.div>
      </section>
      ...
      <section className="w-full py-12 px-8 relative z-10">
        ...
        >
          ...
          <div className="mb-6 flex items-center justify-center gap-4">
            ...
            <span className="text-sm uppercase tracking-[0.3em] font-sans font-bold text-foreground drop-shadow-sm">Since 1985</span>
            <span className="w-16 h-[3px] bg-foreground"></span>
          </div>
          ...
          <p className="text-lg md:text-xl font-sans text-foreground/90 leading-relaxed mb-12 font-medium max-w-[800px] mx-auto">
            Dressing generations of classical dancers with perfectly tailored, handwoven silk costumes that honor tradition and elevate performance.
          </p>
          
          <div>
            <Link href="#collection" className="btn-structured border-foreground bg-foreground text-white hover:bg-transparent hover:text-foreground shadow-xl text-sm md:text-base">
              Explore Collection
            </Link>
          </div>
        </motion.div>
