...
export default function TailoringHero() {
  ...
  return (
    <section ref={ref} className="relative w-full min-h-[90vh] flex items-center justify-center bg-background px-6 lg:px-20 pt-32 pb-16 overflow-hidden">
      <div className="max-w-[1400px] w-full mx-auto flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8">
        ...
        >
          ...
          >
            With over 15 years of master craftsmanship, Sri Sanjana specializes in pure Kanchipuram silks, raw silks, and delicate georgettes. We stitch your vision into reality with mathematically precise cuts and unmatched traditional detailing.
          </motion.p>
          <motion.div
          ...
          >
            <a href="#contact" className="inline-flex items-center gap-3 bg-foreground text-background px-8 py-4 text-xs font-bold uppercase tracking-[0.2em] hover:bg-gold transition-colors duration-300">
              Book a Consultation
        ...
        <div className="w-full lg:w-1/2 relative flex justify-end">
          ...
          >
            <motion.div style={{ y }} className="absolute inset-[-10%] w-[120%] h-[120%]">
              <Image 
                src="/assets/service_tailoring_1783356135602.png" 
