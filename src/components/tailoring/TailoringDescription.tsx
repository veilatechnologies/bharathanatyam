      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-24">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col justify-center space-y-8 p-10 md:p-14 h-full bg-background/95">
              <div className="flex items-center gap-6">
                ...
                <p className="text-xl md:text-2xl font-serif text-foreground font-medium">Ready-Made Blouses Available</p>
              </div>
              ...
              <div className="flex items-center gap-6">
                ...
                <p className="text-xl md:text-2xl font-serif text-foreground font-medium">Aari Work Blouses</p>
              </div>
              <div className="w-12 h-[1px] bg-foreground/20 ml-20"></div>
              <div className="flex items-center gap-6">
                <div className="w-14 h-14 rounded-full border border-gold/30 flex items-center justify-center bg-gold/5 shrink-0">
                ...
                <p className="text-xl md:text-2xl font-serif text-foreground font-medium">Machine Embroidery Blouses</p>
              </div>
            </div>
          </motion.div>

          {/* Right Column: Stitching List */}
          <motion.div
            initial={{ opacity: 0, x: 30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8 font-sans text-lg text-foreground/80">
