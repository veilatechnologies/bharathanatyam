    ...
    <main className="w-full min-h-screen relative selection:bg-foreground selection:text-white flex flex-col">
      ...
      <div className="flex-grow pt-32 pb-24 px-6 max-w-[1400px] mx-auto w-full">
        ...
        <section className="mb-16">
          ...
          >
            <Link href="/bharathanatyam" className="inline-flex items-center gap-2 text-foreground/50 hover:text-foreground text-xs uppercase tracking-widest font-bold mb-8 transition-colors">
