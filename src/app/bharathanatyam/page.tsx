    ...
    <main className="w-full min-h-screen relative selection:bg-foreground selection:text-white flex flex-col">
      ...
      <div className="flex-grow pt-32 pb-24 px-6 max-w-[1400px] mx-auto w-full">
        ...
        <section className="text-center mb-16">
          <Link href="/" className="inline-flex items-center gap-2 text-foreground/50 hover:text-foreground text-xs uppercase tracking-widest font-bold mb-8 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          <Link href="/bharathanatyam/sun-pleated-pant" className="group block">
            <motion.div 
